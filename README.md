...
$$
\text{output\_height} = \frac{{\text{input\_height} - \text{kernel\_size} + 2 \times \text{padding}}}{{\text{stride}}} + 1
$$
$$
\text{output\_width} = \frac{{\text{input\_width} - \text{kernel\_size} + 2 \times \text{padding}}}{{\text{stride}}} + 1
$$
